<template>
	<view id="confirm">
		<view class="returnArea" @click="goRegiester">
			<image src="../static/return.png" mode="" class="returnIcon"></image><text class="returnText">Confirmation mnemonics</text>
		</view>
		<text class="tipsInfo">Please choose the appropriate mnemonic words to ensure the correct
			order</text>
		...
		<view class="chooseArea">
			<view v-for="item in chooseArr" :key="item.id" :class="
          item.isSlected == true
