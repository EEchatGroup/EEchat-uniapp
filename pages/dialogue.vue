  ...
  <view id="dialogue">
    <view class="mask" :style="{ display: showMask ? 'flex' : 'none' }">
      ...
      <view class="btn-list">
        ...
        <view class="press-btn" @longpress="startSpeack" @touchend="stopSpeack"
          >long press when speacking</view
        >
      </view>
    </view>
    ...
    <view class="headCon">
      <view class="head">
        ...
        <view class="headMiddle">
          ...
          <view class="headMiddleBottom" @click="setStatusShow = true"
            ><text>{{ onlineStatus }}</text>
            <image
              src="../static/moreStatus.png"
              mode=""
              class="moreStatus"
            ></image>
          </view>
      ...
      <view class="promptInfo" v-if="statusChangeShow">
        ...
        <text class="changeInfo"
          >Your status has been switched to {{ onlineStatus }}</text
        >
      </view>
    </view>
      ...
      <view v-for="item in list" :key="item.serverMsgID">
        ...
        >
          ...
          <view class="contentArea" style="text-align: right">
            <view
              class="operationBox"
              v-if="item.createTime == chooseCreateTime"
            >
            ...
            >
              ...
              <image
                class="my-img"
                :src="JSON.parse(item.content).snapshotPicture.url"
                mode="heightFix"
              >
              </image>
            </view>
    ...
    <view class="bottomArea">
      <view class="bottomAreaTop">
        ...
        <image
          ...
          mode=""
          class="moreOperation"
          @click="isMoreOperation = !isMoreOperation"
        ></image>
      ...
      <view class="setStatus" v-if="setStatusShow">
        ...
        <image
          src="../static/closeSetStastus.png"
          mode=""
          class="closeSetStastus"
...
<script>
import { changeAlias, send_msg } from "../api";
      ...
      if (index === 0) {
        ...
        uni.chooseVideo({
          ...
          success: (res) => {
            ...
            const newVideoMessage = _this.$openSdk.createVideoMessage(
              url,
              suffix,
              res.duration,
              snapshot
