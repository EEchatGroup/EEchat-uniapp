...
export default {
  data() {
    return {
      account:
        "drastic border repeat evoke ahead capable cabin novel card dignity vote family",
      loginInfo: {
        mnemonic: "",
        publicKey: "",
        address: "",
    ...
    async login() {
      ...
      uni.request({
        ...
        success(res) {
          ...
          const uid = "7eefe8fc74afd7c6adae6d0bc76929e90074d5bc";
          const token =
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVSUQiOiI3ZWVmZThmYzc0YWZkN2M2YWRhZTZkMGJjNzY5MjllOTAwNzRkNWJjIiwiUGxhdGZvcm0iOiJXZWIiLCJleHAiOjE2MjQ5NTExNzMsImlhdCI6MTYyNDM0NjM3MywibmJmIjoxNjI0MzQ2MzczfQ.ZNJYMZu0oZ6JrTIvp1CbMCgLdieNAtKKoTOmEWczpqg";
